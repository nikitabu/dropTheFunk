...
$(function() {
  ...
  // create Model, by extending Backbone.Model
  ...
  window.TrackList = Backbone.Collection.extend({
		...
		//looks like it's stopping the current track and starting the one that was just clicked on
  ...
  // create a view class for the track view
  ...
  // create a view class for the app view
  window.AppView = Backbone.View.extend({
		...
		defaults: {
		  ...
		  download: true,
		  env: 'production',
		  key: 'ybtyKcnlhP3RKXpJ58fg', //stratus's key, should change this to our's when we move it to our server
